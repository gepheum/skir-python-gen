...
class PythonModuleCodeGenerator {
  ...
  generate(): string {
    ...
    this.pushLine("#");
    this.pushLine("# Generated by skir-python-gen");
    this.pushLine("# Home: https://github.com/gepheum/skir-python-gen/");
    this.pushLine("#");
  ...
  private writeClassForEnum(record: RecordLocation): void {
    ...
    for (const wrapperVariant of wrapperVariants) {
      ...
      this.pushDocstring([
        `Create a '${name}' variant wrapping around the given value.\n`,
